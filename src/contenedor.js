...
class Contenedor {
  ...
  async _readFileOrCreateNewOne() {
    try {
      ...
      error.code === "ENOENT"
        ...
        : console.log(
            `Error de código ${error.code} | Hubo un error inesperado al intentar leer ${this._filename}`
          );
    }
  }
  ...
  async getById(id) {
    ...
    try {
      ...
      console.log(
        `Error de código: ${error.code} | Hubo un error al intentar eliminar un elemento por su ID (${id})`
      );
    }
  }
  ...
  async updateById(id, newData) {
    try {
      ...
      `Error de código: ${error.code} |Hubo un error al intentar actualizar un elemento por su ID (${id})`
    }
  }
